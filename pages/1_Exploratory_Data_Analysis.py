...
5. [Visulizations](#visualizations)
    * [Histograms](#histogram)
    * [Line Plots](#line-plots)
    * [Volume Plots](#volume)
6. [Close Prices vs Adj. Close Prices](#close-prices-vs-adj-close-prices)
7. [Significant Adjustments in Prices](#significant-adjustments)
8. [Decomposition of TimeSeries](#decomposition-of-timeseries)
''')
...
st.header('Overview:')
st.write('''
We are analyzing Apple Stock (AAPL) Prices from 2012 to 2019.\
...
# Key Observations: Open, High, Low, Close
...
## Volatitlity Between 2012-13 and 2016-17
...
## Displaying Daily Percentage Changes in Closing Prices
...
## Displaying Volume Traded over Time plot
...
## Displaying Correlation between Volume and Close Price
...
# Displaying AAPL Close Price vs Adj Close
...
st.subheader('Significant Adjustments')

# Displaying Comparision of Close and Adj. Price
