...
st.sidebar.markdown('''
## Table of Contents:
1. [Introduction](#welcome-to-the-apple-stock-analysis-and-forecasting-dashboard)
2. [Project Overiew](#project-overview)
    * [Objective](#objective)
...
4. [Summary](#summary)
5. [How to Use this Dashboard](#how-to-use-this-dashboard)
''')
